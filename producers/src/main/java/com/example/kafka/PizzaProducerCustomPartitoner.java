...
public class PizzaProducerCustomPartitoner {
    public static final Logger logger = LoggerFactory.getLogger(PizzaProducerCustomPartitoner.class.getName());
    ...
    public static void sendMessage(KafkaProducer<String, String> kafkaProducer,
        ...
        if (!sync) {
            kafkaProducer.send(producerRecord, (metadata, exception) -> {
                if (exception == null) {
                    logger.info("async message: " + pMessage.get("key") + metadata.partition() +
...
//        props.setProperty(ProducerConfig.PARTITIONER_CLASS_CONFIG, "CustomPartitioner");
